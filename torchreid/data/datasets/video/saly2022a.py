...
class Saly2022(VideoDataset):
    ...
    def __init__(self, root='', min_seq_len=0, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'saly2022/train')
        self.query_dir = osp.join(self.dataset_dir, 'saly2022/query')
        self.gallery_dir = osp.join(
            self.dataset_dir, 'saly2022/gallery'
        )
        ...
        for pdir in pdirs:
            ...
            for tdir in tdirs:
                ...
                for img_idx in range(num_imgs):
                    ...
                    img_idx_name = str(img_idx + 1).zfill(4)
                    res = glob.glob(
